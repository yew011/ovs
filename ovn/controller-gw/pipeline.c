...
pipeline_run(struct controller_gw_ctx *ctx)
{
    ...
    /* Collects and categorizes bindings from ovnsb. */
            ...
            if (find_umr_by_mac(&ucast_macs_rmts, mb->mac, &umr)) {
                ...
                if (mb->binding->chassis[0]) {
                    ...
                    if (find_pl_by_dst_ip(&physical_locators,
                        ...
                        /* TODO: add pl entry to 'physical_locators'. */
                    }
                } else {
                ...
                if (mb->binding->chassis[0]) {
                    ...
                    /* TODO: add umr entry to 'ucast_macs_rmts'. */
    ...
    lswitch_map_destroy(&non_lswitches);
