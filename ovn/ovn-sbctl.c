...
struct cmd_show_table cmd_show_tables[] = {
    {&sbrec_table_chassis,
     ...
     {&sbrec_chassis_col_encaps,
      &sbrec_chassis_col_gateway_ports,
      NULL},
     false},
    ...
    {&sbrec_table_gateway,
     &sbrec_gateway_col_attached_port,
     {NULL,
      NULL,
      NULL},
     false},
...
const struct ctl_table_class tables[] = {
    ...
    {&sbrec_table_gateway,
     {{&sbrec_table_gateway, &sbrec_gateway_col_attached_port, NULL},
      {NULL, NULL, NULL}}},
...
static const struct ctl_command_syntax sbctl_commands[] = {
    /* Chassis commands. */
    {"add-ch", 3, 3, "CHASSIS ENCAP-TYPE ENCAP-IP", pre_get_info, cmd_add_ch, NULL, "--may-exist",
     RW},
    {"del-ch", 1, 1, "CHASSIS", pre_get_info, cmd_del_ch, NULL, "--if-exists",
     RW},
